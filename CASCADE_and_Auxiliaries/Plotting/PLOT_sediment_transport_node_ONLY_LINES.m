...
%%%% PLOTS ONLY LINES (NO GRAIN SIZE9ENABLES DATA CURSOR MODE
...
%         plot(xxx,[PP3(ptl, ds_path_nodes(1:end-1)) 1],'color',cmap_2(c_classkk(kk),:));
          plot(xxx,[PP4(ptl, ds_path_nodes(1:end-1)) 1],'color',cmap_1(end,:));
...
% 
%% THIS SECTION IS DEACTIVATED IN THIS VERSION 
