...
% Import the data
[~, ~, raw] = xlsread('E:\Connectivity classification Da\Matlab\Import_Data\20150817_Final_River_Net_V1.xlsx','Data','A2:S49806');
...
% Import the data
[~, col_names, raw] = xlsread('E:\Connectivity classification Da\Matlab\Import_Data\20150817_Final_River_Net_V1.xlsx','Variable Names');
raw(cellfun(@(x) ~isempty(x) && isnumeric(x) && isnan(x),raw)) = {''};
